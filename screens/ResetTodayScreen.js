...
// this page written in App.js file as inline so
//  we need not this file but we want to to redirct new page mean we will use this 
...
//               //the home page timer will be reset to 0 after clcik reset today
//               setTotalTime(0);
//               setSessions(0);

//               //this will move to home page 
